...
var bannerpush={
		...
		init:function(){
				...
				$(".input-append a").click(function(){
					weixinfileup.chooseImage(this,function(imgurl){
						weixinfileup.uploadImage(imgurl,function(url){
							var imgPath="/@com_id/banner"+common.getbannershuzi()+".jpg";
			...
			$(".modal-first,.modal-cover").show();
			var path="dak.json";
			$.get("../manager/getJSONObjectByFile.do",{"path":path},function(data){
				$("#description").val(data.description);
				$("#keywords").val(data.keywords);
			});
			$(".modal-first .btn-default,.modal-first .close").click(function(){
				$(".modal-first,.modal-cover").hide();
			});
			$(".modal-first .btn-primary").unbind("click");
			$(".modal-first .btn-primary").click(function(){
				var json={"description":$("#description").val(),"keywords":$("#keywords").val()};
				$.post("../manager/saveJSONObjectFile.do",{
