...
<link rel="stylesheet" href="../p1/css/manage.css${requestScope.ver}">
...
<link rel="stylesheet" href="../p1/cms/css/flattingshow.css${requestScope.ver}">
<link rel="stylesheet" href="../p1/css/edit.css${requestScope.ver}" >
<link href="../p1/images/logo.ico" type="image/x-icon" rel="shortcut icon" />
	...
	<div class="secition">
		<div class="secition_box">
			<div class="secition_box_top clearfix">
					<div class="fl x-active">活动<span class="ui_type" style="display: none;">1</span></div>
					<div class="fl">头条<span class="ui_type" style="display: none;">2</span></div>
			</div>
			<!-- 案例-->
...
$(function(){
	...
	if(projectType==1){
		$('.secition_box_top>div').eq(0).click();
	}
});
</script>
</body>
