...
<link rel="stylesheet" href="../p1/cms/css/global.css">
...
<link rel="stylesheet" href="../p1/cms/css/case_detail.css">
...
<a href="#" onclick="history.go(-1);" class="header_left">返回</a><%=json.getString("title")%></div>
</nav>
