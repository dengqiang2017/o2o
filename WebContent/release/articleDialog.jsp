...
<div class="form_group">
    <div class="col-lg-2">
    <label class="form_label" id="titlel">标题</label>
    </div>
    <div class="col-lg-10">
    ...
    <div class="col-lg-2">
        <label class="form_label" id="timel">时间</label>
        </div>
    <div class="col-lg-10">
...
<script type="text/javascript" src='../cmsjs/articleDialog.js${requestScope.ver}'></script>
