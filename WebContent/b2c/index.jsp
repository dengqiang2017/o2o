...
<!-- 头条 -->
<div style="padding-top: 10px;padding-bottom: 10px;display:  ;" id="toutiao">
...
<div class="case">
    ...
    <div class="case_list clearfix center-block">
    </div>
<div id="xptsitem" style="display: none;">
       <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
           <div class="case_list_box">
               ...
               <span class="wordT" id="price_display" style="text-decoration:line-through;font-size: 12px;">0</span></div>
           </div>
       </div>
</div>
    <!-- 活动促销-->
<!--     <div class="case_title" style="display: none;"> -->
<!--         <div class="case_title_box clearfix center-block" style="width: 75%"> -->
...
<!--
setTimeout(function(){
	var img=$("#fade img")[0].src;
	if(!img){
		img="http://www.pulledup.cn/001Y20/img/CP00000103/cp/0.png";
	}
weixinShare.init($("title").html(),"${requestScope.description}",$("#fade img")[0].src);
}, 2000);
//-->
</script>
</body>
