...
<!-- 							<p style="color: white;">金币:1233个</p> -->
							<a href="jinbi.jsp?com_id=${sessionScope.customerInfo.com_id}" class="btn btn-info btn-sm" style="color:yellow;font-weight: bold;">领金币</a>
...
<!-- 						<button type="button" class="btn btn-info btn-sm">客服</button> -->
						</div>
					</div>
						<a href="modified_data.jsp?com_id=${sessionScope.customerInfo.com_id}" class="edit">编辑资料</a>
<!-- 						<div class="head_portrait"> -->
<!-- 							<div class="a_position" style="display: none;"> -->
<!-- 								<a class="head_portrait_amend" style="display: none;" id="sctx"><img -->
<!-- 									src="images/camera.png"></a> <a class="head_portrait_amend" -->
<!-- 									id="upload-btn"> <input type="hidden" name="typeImg" -->
<!-- 									id="filePath"> <input type="file" -->
<!-- 									class="ct input-upload" name="Pic_You" id="Pic_You" -->
<!-- 									onchange="imgCLientUpload(this);"> <img -->
...
<!-- 						</div> -->
					...
					<div class="order_title">
						 <div class="col-xs-4 borderright" onclick="window.location.href='jinbihistroy.jsp?com_id=${sessionScope.customerInfo.com_id}';">
						 <div id="jinbicount"></div>
						 <div>金币</div>
						 </div>
						 <div class="col-xs-4 borderright" onclick="window.location.href='mycoupon.jsp?com_id=${sessionScope.customerInfo.com_id}';">
						 <div id="couponcount"></div>
						 <div>优惠券</div>
						 </div>
						 <div class="col-xs-4" onclick="window.location.href='browsingHistory.jsp?com_id=${sessionScope.customerInfo.com_id}';">
					...
					<!------订单-- 非消费者,显示报价单---->
					<c:if test="${sessionScope.operatorType=='b-b'}">
					<div class="order_title">
					<div class="pull-left borderright" onclick="window.location.href='addFileList.jsp?com_id=${sessionScope.customerInfo.com_id}';">
					<div>订单附件</div>
					<div style="font-size: 12px;color: #999999;">上传订单附件,查看历史上传</div>
					</div>
					<div class="pull-left borderright" onclick="window.location.href='addedList.jsp?com_id=${sessionScope.customerInfo.com_id}';">
					<div>我的报价单</div>
					<div style="font-size: 12px;color: #999999;">查看产品报价,下订单</div>
					</div>
					<div class="pull-left borderright" onclick="window.location.href='payList.jsp?com_id=${sessionScope.customerInfo.com_id}';">
					<div>我要付款</div>
					<div style="font-size: 12px;color: #999999;">上传支付凭证</div>
					</div>
					<div class="pull-left" onclick="window.location.href='statement.jsp?com_id=${sessionScope.customerInfo.com_id}';">
					<div>我的账单</div>
				...
				<div class="container">
				<div class="col-xs-4">
						<a href="index.jsp?com_id=${sessionScope.customerInfo.com_id}"> <span class="fa fa-home fa-fw" aria-hidden="true"></span> <span>首页</span>
						</a>
					</div><div class="col-xs-4">
						<a href="shopping_cart.jsp?com_id=${sessionScope.customerInfo.com_id}"> <span class="fa fa-shopping-cart" aria-hidden="true"></span> <span>购物车</span>
						</a>
					</div><div class="col-xs-4">
						<a href="personal_center.jsp?com_id=${sessionScope.customerInfo.com_id}"> <span class="fa fa-user fa-fw active" aria-hidden="true"></span> <span class="active">我</span>
						</a>
					</div></div>
					<div class="clearfix"></div>
				</div>
