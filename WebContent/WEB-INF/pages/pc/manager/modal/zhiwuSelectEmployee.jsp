...
<div class="modal-body" style="max-height:260px; overflow-y:scroll; padding: 10px;">
	...
	<li>
	<div class="pro-check" style="width:30px;margin:auto"></div><span>门卫</span>
	</li>
	<li>
	<div class="pro-check" style="width:30px;margin:auto"></div><span>发货</span>
	</li>
	<li>
	<div class="pro-check" style="width:30px;margin:auto"></div><span>物流打包员</span>
	</li>
	<li>
	<div class="pro-check" style="width:30px;margin:auto"></div><span>系统管理员</span>
	</li>
	</ul>
			</div>
