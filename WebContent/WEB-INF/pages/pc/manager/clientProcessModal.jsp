				...
				<div class="form-group" style="text-align: center;">
		          ...
		          <div class="form-group" id="clerk_nameSelect">
		            ...
		            <div class="input-group" id="customer">
						<span class="form-control input-sm"  title="点击选择客户成员" id="customer_name"></span>
							<span class="input-group-btn">
						<input type="hidden"  name="customer_id" id="customer_id">
						<button class="btn btn-default btn-sm" type="button">X</button>
						        <button class="btn btn-success btn-sm" type="button">选择客户员工</button>
					    </span>
					</div>
		            <div class="input-group" id="employee">
						<span class="form-control input-sm"  title="点击浏览选择员工" id="clerk_name"></span>
							<span class="input-group-btn">
						<input type="hidden"  name="clerk_id" id="clerk_id">
						<button class="btn btn-default btn-sm" type="button">X</button>
						        <button class="btn btn-success btn-sm" type="button">选择赛宇员工</button>
					    </span>
					</div>
		          </div>
