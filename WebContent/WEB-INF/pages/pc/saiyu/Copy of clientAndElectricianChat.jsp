...
<title>${requestScope.chatname}</title>
...
<body onload="init();">
    <div class="header">
      <ol class="breadcrumb">
        <li><span class="glyphicon glyphicon-triangle-right"></span><a href="javascript:window.close();">返回</a></li>
        <li class="active"><span class="glyphicon glyphicon-triangle-right"></span><span class="info">${requestScope.chatname}</span></li>
      </ol>
      <div class="header-title"><span class="info">${requestScope.chatname}</span>
        <a href="javascript:window.close();" class="header-back"><span class="glyphicon glyphicon-menu-left"></span></a>
      </div>
    </div>
	<div class="container"> 
