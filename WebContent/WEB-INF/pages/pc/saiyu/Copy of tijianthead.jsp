...
<th colspan="${requestScope.colum}">光源国际品牌1</th>
<th colspan="${requestScope.colum}">光源国际品牌2</th>
<th colspan="${requestScope.colum}">光源国内品牌1</th>
<th colspan="${requestScope.colum}">光源国内品牌2</th>
<th colspan="${requestScope.colum}">光源国内品牌3</th>
<th rowspan="2">电器照片</th>
<th rowspan="2">电器名称</th>
<th rowspan="2">电器型号</th>
<th rowspan="2">数量/套（原配灯具）</th>
<th rowspan="2" style="color: red;">损坏数量</th>
<th colspan="${requestScope.colum}">电器国际品牌1</th>
<th colspan="${requestScope.colum}">电器国际品牌2</th>
<th colspan="${requestScope.colum}">电器国内品牌1</th>
<th colspan="${requestScope.colum}">电器国内品牌2</th>
<th colspan="${requestScope.colum}">电器国内品牌3</th>
