...
<title>青清源供应商-上传资料</title>
<link rel="stylesheet" href="../pcxy/css/bootstrap.css">
<link rel="stylesheet" href="../pc/css/uploading.css">
...
<div class="modal-first" style="display:none;">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<button type="button" id="sctx"  class="btn btn-primary btn-sm m-t-b" style="height: 40px;width: 200px;">上传图片</button>
