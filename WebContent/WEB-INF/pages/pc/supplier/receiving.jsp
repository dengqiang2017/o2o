...
<div class="section">
    ...
    <c:forEach items="${requestScope.list}" var="item">
        <div class="div-bg" style="background-color: #FFFFFF;">
            ...
            <input type="hidden" value="${item.item_id}"></div>
	...
	<input type="hidden" value="财务" id="headship">
	<div style="height: 46px;">

	<button class="btn btn-primary btn-lg" id="allcheck" style="float: left;">全选</button>


	<button class="btn btn-primary btn-lg" style="float: left;">验收并通知财务</button>
	</div>
<span id="store_struct_id" style="display: none;">WH000256</span>
