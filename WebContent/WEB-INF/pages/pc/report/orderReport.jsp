...
<head>
	...
	<script type="text/javascript" src="../pc/js/report/orderReportDeptDetail.js?ver=001"></script>
</head>
<body>
<div class="bg"></div>
<div class="header">
	<ol class="breadcrumb">
	  ...
	  <li class="active"><span class="glyphicon glyphicon-triangle-right"></span>销售报表</li>
	</ol>
	<div class="header-title">员工-销售报表
