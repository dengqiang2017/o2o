...
<script type="text/javascript"
	src="../pc/js/report/salesCommission.js${requestScope.ver}"></script>
</head>
<body>
	<div id="list">
		<div class="header">
			<ol class="breadcrumb">
				...
				<li class="active"><span
					class="glyphicon glyphicon-triangle-right"></span>直销提成报表</li>
			</ol>
			<div class="header-title">
				直销提成报表<a class="header-back"><span
			...
			<form class="form-inline" style="overflow: hidden;">
				<div class="col-sm-12 m-t-b" style="padding: 5px 0;">
					<div class="form-group" style="width: 100%">
						<div class="col-lg-3">
							<label for="" style="margin-top: 7px;">提成状态</label>
						</div>
						<div class="col-lg-9">
				...
				<div class="col-sm-6 col-xs-6 m-t-b">
					<div class="form-group">
						<input type="text" class="form-control input-sm" id="searchKey"
							maxlength="20" placeholder="请输入查询关键词">
						<button type="button" class="btn btn-primary btn-sm" id="find">查询</button>
					</div>
<!-- 					<span id="clientfindshow">当前客户:<span id="corpName"></span><span id="customer_id" style="display: none;"></span></span> -->
				</div>
			</form>
			<div class="tree">
				<ul>
					<li><span id="treeAll" style="display: none;"><i class="glyphicon glyphicon-folder-open"></i>所有</span></li>
				</ul>
				<ul>
					<c:forEach items="${requestScope.clients}" var="client">
						<li class="parent_li"><span class="client_tree"><i
								class="glyphicon glyphicon-leaf"></i>${client.corp_name} <input
								type="hidden" value="${client.customer_id}"></span></li>
					</c:forEach>
				</ul>
			</div>
		</div>
...
<!-- 					<button type="button"-->
<!-- 						class="btn btn-primary btn-sm m-t-b">支付提成</button> -->
						...
						<table class="table table-bordered">
							<thead>
								<tr>
									...
									<th width="200">所属上级客户名称</th>
									<th width="200">提成比例(%)</th>
									<th width="200">应提成金额</th>
				...
				<div class="box-footer">
					<div class="form-inline" style="display: none;">
						<div class="form-group pull-left">
							<label>合计</label> <span class="form-control">${requestScope.pages.totalRecord}</span>
						</div>
					</div>
				</div>
			</div>
