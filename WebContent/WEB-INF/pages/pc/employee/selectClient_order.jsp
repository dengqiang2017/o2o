...
<div class="header">
	<ol class="breadcrumb">
	  ...
	  <li class="active"><span class="glyphicon glyphicon-triangle-right"></span>代下订单-选择客户</li>
	</ol>
	<div class="header-title">员工-代下订单-选择客户
...
<div class="container-fluid" style="margin-top:10px;">
	<div class="row">
		<div class="col-lg-4 col-md-6" id="finddiv">
			...
			<div class="ctn-fff box-ctn" style="height:750px;">
				<div class="box-head"><h4 class="pull-left">客户列表</h4>
					...
					<a onclick="$('#scroll').click();" class="btn btn-success">查询客户</a>
						<a id="order" class="btn btn-success">代下订单</a>
					</div>
			  	</div>
				<div class="box-body">
