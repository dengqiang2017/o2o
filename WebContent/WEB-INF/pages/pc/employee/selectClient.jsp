...
<div class="header">
	<ol class="breadcrumb">
	  ...
	  <li class="active"><span class="glyphicon glyphicon-triangle-right"></span>增加品种-选择客户</li>
	</ol>
	<div class="header-title">员工-增加品种-选择客户
				...
				<div class="box-head">
					...
					<input type="hidden" id="employeeId" value="${sessionScope.userInfo.clerk_id}">
						...
						<div class="col-sm-6 m-t-b">
							<div class="form-group">
					    		<label>手机号</label>
					    		<input type="text" class="form-control input-sm" id="personnel.clerk_name" maxlength="11" >
					  		</div>
						</div>
						<div class="col-sm-6 m-t-b">
							<div class="form-group">
...
<!-- 						<a href="#" class="btn btn-success">销售合同</a> -->
					</div>
			  	</div>
				<div class="box-body">
