...
<body>
    ...
    <div class="header">
      <ol class="breadcrumb">
        ...
        <li><span class="glyphicon glyphicon-triangle-right"></span>离职交接</li>
      </ol>
      <div class="header-title">员工-离职交接
			...
			<div class="box-body">
        		<div class="col-sm-6">
  					<div class="item-card item-card01">
  						...
  						<div class="item-head">
  							<a class="selectEmployee">点击选择离职人</a>
  						</div>
  					</div>
        		</div>
        		<div class="col-sm-6">
				...
				<div class="ctn text-center">
					<a  id="leaveTransfer" type="botton" class="btn btn-lg btn-primary">确认交接</a>
