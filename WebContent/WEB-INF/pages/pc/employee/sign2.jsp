...
<body onload="init()">
	<div class="container">
		...
		<div class="picture-ctn">
			<div class="pic-icon"><span class="glyphicon glyphicon-camera"></span><span class="text">来张照片说明我在工作</span></div>
			<div class="pic" style="display:none;"><img src="" alt=""></div>
			<input type="file" name="imgFile" id="imgFile"  accept="image/jpeg"  onchange="imgUpload(this);">
		</div>
		<div class="sign-remark" id="imginfo">
		</div>
