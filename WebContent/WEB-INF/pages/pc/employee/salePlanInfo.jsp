...
<div class="header">
	<ol class="breadcrumb">
	  ...
	  <li><span class="glyphicon glyphicon-triangle-right"></span><a href="salePlan.do">销售计划报表</a></li>
	  <li class="active"><span class="glyphicon glyphicon-triangle-right"></span>销售计划详细</li>
	</ol>
	<div class="header-title">销售计划详细
		<a href="salePlan.do" class="header-back"><span class="glyphicon glyphicon-menu-left"></span></a>	
	</div>
			...
			<div class="ctn-fff box-ctn" style="height:750px;">
				...
				<form action="" style="clear:both;overflow:hidden;">
		            ...
		            <div class="col-sm-3 col-lg-2 m-t-b">
		              <div class="form-group">
		                <label for="">日期</label>
		                <input type="text" class="form-control input-sm" name="${sessionScope.prefix}" maxlength="50">
		              </div>
		            </div>
		            <div class="ctn">
