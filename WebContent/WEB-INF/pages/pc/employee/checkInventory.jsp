			...
			<div class="box-body">
                ...
                <div style="border-bottom: 1px solid aqua;">
                   ...
                   <div class="col-xs-12 col-sm-6 col-md-6" id="cgNum">
                    <label for="" data-number="n">盘点数量</label>
                    <span id="oper_qty"></span>/<span class="item_unit"></span>
                  </div>
                  <div class="col-xs-12 col-sm-6 col-md-6">
                    <label for="">盈亏金额</label>
                  <span>¥</span><span id="sum_si"></span>元
                  </div>
                   <div class="col-xs-12 col-sm-6 col-md-6" id="bsdh">
                    <label for="">盘点单号</label>
                    <span id="ivt_oper_listing"></span>
                  </div>
                    <div class="col-xs-12 col-sm-6 col-md-6" id="bsp">
                    <label for="">盘点人</label>
                    <span id="pd_name"></span>
                  </div>
                  <div class="col-xs-12 col-sm-6 col-md-6">
                    <label for="">盘点仓库</label>
                   	 <input type="hidden" id="store_struct_id">
                     <span id="store_struct_name"></span>
                  </div>
                  <div class="col-xs-12 col-sm-6 col-md-6" id="dqkc">
                    <label for="">当前库存</label>
                    <span id="kc"></span>/<span class="item_unit"></span>
                  </div>
                    <div class="col-xs-12 col-sm-6 col-md-6" id="pqkc">
                    <label for="">盘前数量</label>
                    <span id="base_oq"></span>/<span class="item_unit"></span>
                  </div>
...
<script type="text/javascript" src="../pc/js/employee/checkInventory.js${requestScope.ver}"></script>
</body>
</html>