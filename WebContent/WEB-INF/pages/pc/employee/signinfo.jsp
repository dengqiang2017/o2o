...
<script src="../pc/js/employee/sign.js${requestScope.ver}"></script>
<style type="text/css">
tbody tr{
cursor: default;
}
...
<div class="left-hide-ctn">
	...
	<div class="col-lg-9">
	    		...
	    		<option value="1" selected="selected">正常签到</option>
	    		<option value="2">上午迟到</option>
	    		<option value="3">上午早退</option>
	    		<option value="4">下午迟到</option>
	    		<option value="5">下午早退</option>
	    		<option value="0">未签到</option>
	    		<option value="6">已签到</option>
	    		</select>
	</div>
	  		</div>
		</div>
...
<!-- 		<span style="float: left;margin: 6px 10px;">~</span> -->
<!-- 		<input type="time" class="form-control input-sm Wdate xx begintime hh" onfocus="WdatePicker({dateFmt:'HH:mm:ss'})" style="float:left;"> -->
...
<!-- 		<span style="float: left;margin: 6px 10px;">~</span> -->
<!-- 		<input type="time" class="form-control input-sm Wdate xx endtime hh" onfocus="WdatePicker({dateFmt:'HH:mm:ss'})" style="float:left;"> -->
	<div style="clear:both"></div>
	</div>
		</div>
		</div>
...
<div class="container" style="margin-bottom:50px">
	<div class="ctn-fff box-ctn" style=";">
		...
		<button type="button" id="manager_expand" class="btn btn-primary btn-sm m-t-b">展开搜索</button>
			...
			<button type="button" class="btn btn-danger btn-sm m-t-b" id=parambtn>签到查询参数设置</button>
  	</div>
		<div class="box-body">
...
<!-- 		<div> <textarea rows="5" cols="40" id="log" style="width: auto;" wrap="soft"></textarea> </div> -->
		<div class="form-group" >
		 <div style="width: 803px; height: 500px;color: black;float: left;" id="container"></div>
		<div class="" id="img" style="padding:20px 0;float: left;">多图片显示区
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
				...
				<h4 class="modal-title">签到查询参数设置</h4>
			</div>
			<div class="modal-body" style="overflow-y:scroll; padding: 10px;">
				...
				<div class="ctn" style="padding-left:20px;margin-bottom:5px;">
					...
					<input type="time" id=morningendTime class="form-control input-sm Wdate xx hh" 
				...
				<div class="ctn" style="padding-left:20px;margin-bottom:5px;">
					...
					onfocus="WdatePicker({dateFmt:'HH:mm:ss',isShowClear:false})" value="13:00:00">
				</div>
				<div class="ctn" style="padding-left:20px;margin-bottom:5px;">
					<label class="radio-inline">
					  下午迟到时间
					</label>
					<input type="time" id=afternoonLateTime class="form-control input-sm Wdate xx" 
					onfocus="WdatePicker({dateFmt:'HH:mm:ss',isShowClear:false})" value="13:30:00">
				</div>
				<div class="ctn" style="padding-left:20px;margin-bottom:5px;">
					<label class="radio-inline">
					  下午下班时间
					</label>
					<input type="time" id=afternoonEndTime class="form-control input-sm Wdate xx hh" 
					onfocus="WdatePicker({dateFmt:'HH:mm:ss',isShowClear:false})" value="17:30:00">
				</div>
			</div>
