...
<div class="header">
	<ol class="breadcrumb">
	  ...
	  <li class="active"><span class="glyphicon glyphicon-triangle-right"></span>我的客户</li>
	</ol>
	<div class="header-title">员工-我的客户
...
<div class="container-fluid" style="margin-top:10px;">
	<div class="row">
						...
						<div class="col-sm-6 m-t-b">
							<div class="form-group">
					    		...
					    		<select class="form-control input-sm" id="ditch_type">
					                  ...
					                  <option value="普通经销商">普通经销商</option>
					                  <option value="合同经销商">合同经销商</option>
					                </select>
					  		</div>
						</div>
						<div class="col-sm-6 m-t-b">
							<div class="form-group">
					    		...
					    		<div class="input-group">
									...
									<span class="input-group-btn">
								        ...
								        <button class="btn btn-success btn-sm" type="button" id="regionalismBtn">浏览</button>
								    </span>
								</div>
					  		</div>
						</div>
		...
		<div class="col-lg-8 col-md-6" id="dibu">
			<div class="ctn-fff box-ctn" style="height:750px;">
				<div class="box-head"><h4 class="pull-left">客户列表</h4>
					<div class="pull-right">
					<a onclick="$('#scroll').click();" class="btn btn-success">查询客户</a>
<!-- 						<a id="add" target="_blank" class="btn btn-success">增加品种</a> -->
<!-- 						<a  target="_blank" class="btn btn-success">代下订单</a> -->
<!-- 						<a  target="_blank" class="btn btn-success">报价单</a> -->
<!-- 						<a  target="_blank" class="btn btn-success">已下订单</a> -->
<!-- 						<a  target="_blank" class="btn btn-success">客户维护</a> -->
					</div>
			  	</div>
				<div class="box-body">
