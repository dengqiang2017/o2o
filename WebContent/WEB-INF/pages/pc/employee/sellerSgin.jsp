...
<body onload="init()">
	<div class="container">
		...
		<div class="picture-ctn">
			...
			<span class="text">客户大门或内部照片(可以多张)</span></div>
			<div class="pic"></div>
		</div>
		<div class="sign-remark">
			<textarea cols="30" rows="3" placeholder="录入当前位置客户名称等信息"></textarea>
		</div>
		<button type="button" id="openLocation" style="display: none;">上传位置</button>
...
<script type="text/javascript" src="../pc/js/weixin/sellerSign.js${requestScope.ver}"></script>
</body>
</html>