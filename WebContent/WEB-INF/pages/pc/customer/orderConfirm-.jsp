...
<head>
  ...
  <meta name="viewport" content="width=device-width, height=device-height, initial-scale=1,maximum-scale=1.0,user-scalable=no">
	...
	<script type="text/javascript" src="../pc/js/customer/clientOrder.js${requestScope.ver}"></script>
</head>
<body>
	<div class="bg"></div>
	<div class="header">
    ...
    <div class="container">
      <div class="ctn-fff box-ctn">
        ...
        <div class="box-body">
          ...
          <button type="button" id="jstable">结算方式列表</button>
          <div class="table-responsive lg-table" style="display: none;">
            <table class="table table-bordered">
              <thead>
                <tr>  
                   <th width="50" style="display: none;"><div class="checkbox"></div></th>  
                   <th>账户性质</th>
                   <th>结算方式</th>
                   <th>余额</th>
                   <th width="200">支付金额</th>
                </tr>
              </thead>
              <tbody></tbody>
            </table>
          ...
          <h5 id="jeMsg" style="color:red; font-weight:600;display: none;">对不起！您的<label></label>金额不足，差<span>0</span>元,无法完成支付！<label></label></h5>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<c:if test="${sessionScope.customerInfo.ifUseCredit=='是'}">
				...
				<a href="paymoney.do?order" id="paymoney" class="btn btn-danger">去充值</a>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
