...
<script type="text/javascript" src="../pc/js/customer/clientOrder2.js${requestScope.ver}"></script>
    ...
    .list-ul>li{
    border: 1px solid #ddd;padding: 5px;position: relative;margin-bottom:20px;
    }
        ul>li{
        list-style:none;
    }
...
<div class="container">
    <div class="ctn-fff" style="position: relative;margin-bottom:30px">
    <div class="box-subject-header" style="width: 100%;height: 45px;text-align: center;line-height: 45px;background-color: #337AB7;color: #FFFFFF;">订单支付</div>
    ...
    <div style="clear:both"></div>
        ...
        <div class="payorderctn" style="width: 93%;margin-top: 40px;">
...
<h4 style="color:#4b77be;display: none;">截止<span id="nowdate"></span>，您累计的应收款为<span id="ysk">0.00</span>元，账户余额为<span id="zhye">0.00</span>元。 <a target="_blank" href="accountStatement.do" class="btn btn-danger">查看对账单</a></h4>
        </div>
    </div>
</div>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////// -->
