	...
	<div class="container">
		...
		<div class="main">
			...
			<div class="row">
				...
				<div class="signup-btn" onclick="window.location.href='../pc/login.html';">已有账号，直接登录</div>
			</div>
...
<script type="text/javascript" src="../pc/js/registerEwm.js${requestScope.ver}"></script>
...
<!--
weixinShare.init("${requestScope.systemName}","${requestScope.systemName}-客户注册"); 
//-->
</script>
</body>
</html>