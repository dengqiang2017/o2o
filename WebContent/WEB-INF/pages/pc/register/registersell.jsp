...
<head lang="en">
    ...
    <meta name="keywords" content="德阳通威,小猪动车,养殖户">
	<meta name="description" content="德阳通威小猪动车-养殖户注册">
    <title>德阳通威小猪动车-养殖户注册</title>
    <link rel="stylesheet" href="../pc/css/bootstrap.css">
    <link rel="stylesheet" href="../pc/css/registersell.css${requestScope.ver}">
...
<script type="text/javascript">
<!--
weixinShare.init('德阳通威小猪动车','德阳通威小猪动车-养殖户注册',document.getElementsByTagName("img")[0].src); 
register.type="养殖户";
register.upper_customer_id="CS1C001";
