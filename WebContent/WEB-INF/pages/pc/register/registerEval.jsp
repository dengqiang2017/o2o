...
<meta name="keywords" content="${requestScope.systemName},电工注册">
<meta name="description" content="${requestScope.systemName}-电工注册">
<title>电工注册-${requestScope.systemName}</title>
...
<body>
	<div class="container">
		<div class="header">
			...
			<div style="text-align: center;">电工注册</div>
		</div>
		<div class="main">
			<div class="input-group">
				<input type="hidden" value="eval" id="regType">
				<input type="hidden" value="eval" id="erweima">
			...
			<div class="row">
				...
				<div class="signup-btn" onclick="window.location.href='../pc/loginEval.jsp';">已有账号，直接登录</div>
			</div>
		</div>
	</div>
...
<!--
weixinShare.init("${requestScope.systemName}","${requestScope.systemName}-电工注册",document.getElementsByTagName("img")[0].src); 
//-->
</script>
</body>
</html>