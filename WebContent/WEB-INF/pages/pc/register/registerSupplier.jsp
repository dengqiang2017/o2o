...
<meta name="keywords" content="${requestScope.systemName},供应商注册">
<meta name="description" content="${requestScope.systemName}-供应商注册">
<title>供应商注册-${requestScope.systemName}</title>
...
<body>
	<div class="container">
		<div class="header">
			...
			<div style="text-align: center;">供应商注册</div>
		</div>
		<div class="main">
			<div class="input-group">
				...
				<div class="input">
					...
					<input type="text" placeholder="请输入从运营商处获取的授权码" name="com_id" maxlength="11">
				</div>
			</div>
			<div class="input-group">
				<input type="hidden" value="supplier" id="regType">
				<input type="hidden" value="supplier" id="erweima">
				<div class="label"><img src="../pcxy/image/signp01.png" alt=""></div>
				<div class="input">
			...
			<div class="row">
				...
				<div class="signup-btn"><a href="../pc/loginSupplier.jsp" style="float: left;width: 100%;">已有账号，直接登录</a></div>
			</div>
		</div>
	</div>
...
<!--
weixinShare.init("${requestScope.systemName}","${requestScope.systemName}-供应商注册",document.getElementsByTagName("img")[0].src);
var com_id=$("input[name='com_id']");
var id=common.getQueryString("com_id");
if(id){
	com_id.val(id);
}
if($.trim(com_id.val())==""){
	$("input[name='user_id']").attr("readonly","readonly");
	$("input[name='user_password']").attr("readonly","readonly");
	$("input[name='confirmPwd']").attr("readonly","readonly");
