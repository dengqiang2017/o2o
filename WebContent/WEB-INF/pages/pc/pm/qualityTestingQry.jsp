...
<head lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="../css/qualityTestingQry.css">
    ...
    <script type="text/javascript" src="../js/o2otree.js"></script>
   	<script type="text/javascript" src="../pc/js/pm/qualityTestingQry.js"></script>
</head>
<body>
<!-------------------------------header-------------------------------------------------------------------------------->
                ...
                <table class="table table-bordered ta" style="margin-bottom: 130px">
                    ...
                    <tbody>
	                    <tr>
	                        ...
	                        <td>张三</td>
	                        <td>12</td>
	                        <td><a href="repair-paigong4.html"><button type="button" class="tdbt">质检</button></a></td>
	                    </tr>
                    </tbody>
                </table>
            </div>
...
<div class="zz">
    ...
    <div class="zz-one">
        <ul>
            ...
            <li>&emsp;工人名称：<span id="clerk_name"></span></li>
            ...
            <li>&emsp;派工数量：<span id="PGSL"></span></li>
