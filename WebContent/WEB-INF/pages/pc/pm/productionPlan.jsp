...
<head>
    ...
    <link rel="stylesheet" href="../pcxy/css/product.css${requestScope.ver}">
 	...
 	<script type="text/javascript" src="../pc/js/pm/productionPlan.js${requestScope.ver}"></script>
          	...
          	<div class="ctn">
            	<div class="col-sm-4 col-lg-3 m-t-b">
              		<div class="form-group">
                		...
                		<input type="date" class="form-control input-sm Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'planned_delivery_date\')||\'2020-10-01\'}'})" id="store_date">
              		</div>
            	</div>
            	<div class="col-sm-4 col-lg-3 m-t-b">
              		<div class="form-group">
                		<label for="">计划交货日期</label>
                		<input type="text" class="form-control input-sm Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'store_date\')}',maxDate:'2020-10-01'})" id="planned_delivery_date">
              		</div>
            	</div>
            	<div class="col-sm-4 col-lg-3 m-t-b">
              		<div class="form-group">
