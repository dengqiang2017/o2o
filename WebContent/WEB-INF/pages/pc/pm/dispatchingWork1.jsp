...
<head lang="en">
    ...
    <script type="text/javascript" src="../js/ajaxfileupload.js"></script>
   	<script type="text/javascript" src="../pc/js/pm/dispatchingWork1.js"></script>
</head>
<body>
<!-------------------------------header----------------------------->
        ...
        <div class="row">
            <div class="col-xs-12 secition-one" >
                <ul>
                    ...
                    <li>制作要求：<span id="c_memo"></span></li>
                    <li>制作要求：<span id="memo_color"></span></li>
                    <li>制作要求：<span id="memo_other"></span></li>
                </ul>
            </div>
        </div>
        <div class="row smga">
            <div class="col-xs-12 ">
                ...
                <form class="form-one">
                    <ul>
                        ...
                        <li>
                           <div class="secition-two-a">工艺图纸</div>
                           <div class="secition-two-b sm">
                           		<span id=""  aria-describedby="basic-addon2"></span>
                                <span>
                                	<input type="file" id="imgFile" name="imgFile" onchange="imgUpload(this);" style="display:none;">
                                    <button class="smg" type="button">浏览</button>
                                </span>
                           </div>
                        </li>
                        <li id="gytz_display" style="height:130px;display:none;">
                        	<div class="gytzs">
                        		<div class="gytz" style="position:relative;float:left;margin:5px;">
                        			<input type="hidden" id="imgurl">
                        			<img src="" alt="工艺图纸"  style="width:120px;height:120px;">
                        			<button class="btn btn-danger btn-sm" type="button" onclick="delImg(this)" style="position:absolute; left:0px; top:90px;width:120px;height:30px;opacity: 0.9;">点击删除</button>
                        		</div>
                        	</div>
                        </li>
                    </ul>
                    ...
                    <div class="col-xs-12 cl-1" id="props">
                        <div class="cl-2" id="prop">
                            <ul class="ul-mr">
                    			...
                    			<li style="margin-left:5px;"><button class="btn btn-info btn-sm" onclick="seegytz(this)">查看工艺图纸</button></li>
                            </ul>
                            <div class="cl-2-a">
                                <ul>
