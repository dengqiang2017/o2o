...
<link rel="stylesheet" href="../client/bianji/css/edit_modal.css">
<link rel="stylesheet" href="../client/bianji/css/font-awesome.min.css">
...
<script src="../js/popUpBox.js${requestScope.ver}"></script>
<script src="../js/common.js${requestScope.ver}"></script>
<!-- <script type="text/javascript" charset="utf-8" src="cms/js/wordedit.js"></script> -->
<script type="text/javascript" src="js/urlParam.js${requestScope.ver}"></script>
<script src='../cmsjs/url.js${requestScope.ver}'></script>
<script src='../js/ajaxfileupload.js${requestScope.ver}'></script>
<script src='../cmsjs/fileUpload.js${requestScope.ver}'></script>
<script src='../cmsjs/edithtmlData.js${requestScope.ver}'></script>
<script src="../bianji/js/nicEdit.js${requestScope.ver}" type="text/javascript"></script>
</head>

<body>
    <div class="modal_dialog modal_artical"  style="height: 100%;">
        <div class="modal_head">
            编辑文章
            <i class="fa fa-close fa-fw"></i>
        </div>
        <div class="modal_body" style="margin-top:0;">
            <form>
                ...
                <div class="form_group">
                    ...
                    <div class=" col-lg-2">
                        ...
                        <div class="col-lg-10">
                            <div class="img_style">
                                <input class="" type="file" name="imgFile" id="imgFile" onchange="imgonlyUpload(this);" style="position: absolute;width: 100%;height: 100%;opacity: 0;cursor: pointer">
                            </div>
                  ...
                  <div id="videodiv" style="display: none">
                    <div class="form_group" >
                        ...
                        <div class="col-lg-10">
                            <div class="img_style">
                                <input class="" type="file" name="videoFile" id="videoFile" onchange="videoUpload(this);" style="position: absolute;width: 100%;height: 100%;opacity: 0;cursor: pointer">
                            </div>
                        </div>
                    </div>
                    <div class="form_group">
                    ...
                    <div class="form_group">
                        ...
                        <!--<input class="" type="file" name="videoimgFile" id="videoimgFile" onchange="videoimgUpload(this);">-->
                            <div class="img_style">
                                <input class="" type="file" name="videoimgFile" id="videoimgFile" onchange="videoimgUpload(this);" style="position: absolute;width: 100%;height: 100%;opacity: 0;cursor: pointer">
                            </div>
                ...
                <div style="float:left;width: 60%;" id="editarticle">
                    <script type="text/javascript">
					var hgt=$("body").height()-40;
