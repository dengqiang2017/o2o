...
var nicUploadButton = nicEditorAdvancedButton.extend({
	 nicURI: "../upload/uploadWordImg.do?templateName="+window.parent.projectName+"&type="+window.parent.edithtml.type,
    errorText: "上传图片失败",
    addPane: function() {
...
$(function(){
	if(!browser.versions.gecko){
		$("#imgwidth").bind("input propertychange blur",function(){
