...
//				yck_yue+=acct_recieve_sum;
		...
		if (zhye<=0) {
			...
			if ( ddzje>zhye) {
				$("#jeMsg>span").html(numformat(ddzje-zhye,2));
				$("#jeMsg").show();
			}
		}
		///////////////////////////
...
//			2015-10-24版结算方式
			//1.账户余额为负数时不带结算方式相关
			var ddje=$("#jeMsg>span").html();
			if (zhye<=0) {//账户总余额小于等于0
				//不带结算方式里面的金额
				jiesList="";
				jiesListYCK="";
				ddje=ddzje;//当总余额小于等于0,支付金额就是订单总金额
				ljje=(zhye*-1)+ddzje;
			}
			/////////////////////////
			if (b) {
...
//				$.cookie("fuddje","fuddje");/////2015-10-24 23:04
