...
function imgonlyUpload(t){
	...
	ajaxUploadFile({//type=imgonly&
		"uploadUrl" :"/cms/upload/uploadImage.do?fileName=imgFile&templateName="+templateName+imgurl,
		"msgId" : "msg",
		"fileId" : "imgFile",//
		"msg" : "图片",
		"fid" : "filepath",
...
//			$(".logo_image:eq(0)").find("#imginput").val(imgUrl);
			$(".logo_image:eq(0)").find("img").attr("src","/cms/pc/content/"+$.cookie("loginName")+"/"+templateName+"/"+imgUrl+"?ver="+Math.random());
		}
	});
}
function imgonlyUploadPhone(t){
	...
	if (!imgurl) {
		...
		imgurl="&imgurl="+imgurl+"&ver="+Math.random();
	ajaxUploadFile({//type=imgonly&
		"uploadUrl" :"/cms/upload/uploadImage.do?fileName=imgFilephone&templateName="+templateName+imgurl,
		"msgId" : "msg",
		"fileId" : "imgFilephone",//
		"msg" : "图片",
		"fid" : "filepathphone",
...
//		$(".logo_image:eq(1)").find("#imginputphone").val(imgUrl);
		$(".logo_image:eq(1)").find("img").attr("src","/cms/pc/content/"+$.cookie("loginName")+"/"+templateName+"/"+imgUrl+"?ver="+Math.random());
	});
}
function videoimgUpload(t){
	...
	ajaxUploadFile({//type=imgonly&
		"uploadUrl" :"/cms/upload/uploadImage.do?fileName=videoimgFile&templateName="+templateName+imgurl,
		"msgId" : "msg",
		"fileId" : "videoimgFile",//
		"msg" : "图片",
		"fid" : "videofilepath",
...
function videoUpload(t){
	...
	ajaxUploadFile({//type=imgonly&
		"uploadUrl" :"/cms/upload/uploadImage.do?fileName=videoFile&templateName="+templateName+imgurl,
		"msgId" : "msg",
		"fileId" : "videoFile",//
		"msg" : "视频",
		"fid" : "videoaddress",
...
function articleUpload(t){
	...
	ajaxUploadFile({//type=imgonly&
		"uploadUrl" :"/cms/upload/uploadImage.do?fileName=articleFile&templateName="+templateName+imgurl,
		"msgId" : "msg",
		"fileId" : "articleFile",//
		"msg" : "文章",
		"fid" : "",
