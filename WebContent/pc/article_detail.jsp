...
<script type="text/javascript" src="../js/public.js?ver=00111"></script>
<script type="text/javascript" src="../js/weixinAutoLogin.js"></script>
<script type="text/javascript">
<!--
$(function(){
	...
	if(is_weixin()){
		weixinAutoLogin.init("客户", com_id, function(login,userid){
...
// 	var code=getQueryString("code");
	...
	///////////////////////////////
	weixinShare.init("<%=json.getString("title")%>","<%=json.getString("gjc")%>"); 
	$("#imgvideo").hide();
