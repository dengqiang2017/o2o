...
<title>司机登录</title>
<meta name="keywords" content="${requestScope.systemName},司机登录">
<meta name="description" content="${requestScope.systemName}-司机登录">
<title>司机登录-${requestScope.systemName}</title>
...
<body>
	<div class="container">
		<div class="header">
			...
			<div style="text-align: center;">司机登录</div>
		</div>
		<div class="main">
			...
			<div class="signup-btn" id="logindrive">登录</div>
			<div class="signup-btn-light" onclick="window.location.href='../login/register.do?type=Drive';">没有账号，立即注册</div>
...
<!--
$(function(){
	weixinShare.init("${requestScope.systemName}","${requestScope.systemName}-司机登录");
	login.init("logindrive","../saiyu/login.do?type=1","../saiyu/drive.do","drive");
});
//-->
</script>
</body>
