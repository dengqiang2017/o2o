...
<head lang="en">
    ...
    <title>商品详情-${requestScope.systemName}</title>
...
<!--                             	<a href="../bztrgh/product.html">定制</a> -->
                            ...
                            <div class="words">
                                <div class="express" style="font-size: 12px;">安装服务费:<span id="AZTS_free" style="font-size: 12px;">0.00</span></div>
                                <div class="pin" style="font-size: 12px;">月销<span id="salesVolume" style="font-size: 12px;">0</span>笔</div>
                                <div class="site" style="font-size: 12px;">四川达州</div>
                            </div>
                            <div class="clearfix"></div>
                        </div>
       <div class="delivery">
      ...
      <div class="commodity_footer">
                ...
                <ul class="nav nav-tabs" style="margin-top:10px;">
                    ...
                    <li><a>规格参数</a></li>
                    <li><a>产品评价</a></li>
                </ul><div class="tabs-content" id="cpxj">
                    <div class="pro-img">
                        <ul> 
                        </ul>
                    </div>
