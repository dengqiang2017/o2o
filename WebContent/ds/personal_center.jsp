...
<!-- 							<p style="color: white;">金币:1233个</p> -->
							<a href="jinbi.jsp" class="btn btn-info btn-sm" style="color:yellow;font-weight: bold;">领金币</a>
...
<!-- 						<button type="button" class="btn btn-info btn-sm">客服</button> -->
						...
						<a href="modified_data.jsp" class="edit">编辑资料</a>
...
<!-- 						</div> -->
					...
					<div class="order_title">
						 <div class="col-xs-4 borderright" onclick="window.location.href='jinbihistroy.jsp';">
						 <div id="jinbicount"></div>
						 <div>金币</div>
						 </div>
						 <div class="col-xs-4 borderright" onclick="window.location.href='mycoupon.jsp';">
						 <div id="couponcount"></div>
						 <div>优惠券</div>
						 </div>
						 <div class="col-xs-4" onclick="window.location.href='browsingHistory.jsp';">
					...
					<div class="order_title">
					<div class="pull-left borderright" onclick="window.location.href='addFileList.jsp';">
					<div>订单附件</div>
					<div style="font-size: 12px;color: #999999;">上传订单附件,查看历史上传</div>
					</div>
					<div class="pull-left borderright" onclick="window.location.href='addedList.jsp';">
					<div>我的报价单</div>
					<div style="font-size: 12px;color: #999999;">查看产品报价,下订单</div>
					</div>
					<div class="pull-left borderright" onclick="window.location.href='payList.jsp';">
					<div>我要付款</div>
					<div style="font-size: 12px;color: #999999;">上传支付凭证</div>
					</div>
					<div class="pull-left" onclick="window.location.href='statement.jsp';">
					<div>我的账单</div>
					...
					<div class="order_title" onclick="window.location.href='orderList.jsp';">
