...
var nicEditorConfig = bkClass.extend({
    ...
    iconsPath: '/bianji/js/nicEditorIcons.gif',
...
var nicUploadButton = nicEditorAdvancedButton.extend({
	 nicURI: "../upload/uploadWordImg.do?templateName=clerk&htmlname="+edithtml.htmlname,
    errorText: "上传图片失败",
    addPane: function() {
...
$(function(){
		$("#imgwidth").bind("input propertychange blur",function(){console.debug(edithtml.selectImg);
			if(edithtml.selectImg){
				edithtml.selectImg.css("width",$(this).val()+"px");
			}else{
		...
		$("#imgheight").bind("input propertychange blur",function(){
			if(edithtml.selectImg){
				edithtml.selectImg.css("height",$(this).val()+"px");
			}else{
				pop_up_box.toast("请先在右边编辑器中点选图片!",1000);
				$(this).val("");
			}
