...
<div class="container">
	...
	<div class="col-sm-3 col-lg-2 m-t-b">
		<div class="form-group">
			<label for="">起始日期</label> <input id="d4311" class="form-control input-sm Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'d4312\')||\'2020-10-01\'}',isShowClear:false})" name="beginDate" type="text">
		</div>
	</div>
	<div class="col-sm-3 col-lg-2 m-t-b">
		<div class="form-group">
			<label for="">结束日期</label> <input id="d4312" class="form-control input-sm Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'d4311\')}',maxDate:'2020-10-01',isShowClear:false})" name="endDate" type="text">
		</div>
	</div>
	<div class="col-sm-3 col-lg-2 m-t-b">
		<div class="form-group">
			<label for="">状态</label> 
			<select id="visitResult" class="form-control"></select>
		</div>
	</div>
	<div class="col-sm-3 col-lg-2 m-t-b">
	 ...
	 <div class="box-body">
		 <table class="table table-striped table-condensed table-bordered">
            ...
            <tr>
	            ...
	            <th data-name="clerkName">业务员</th>
	            <th data-name="clientName">客户名称</th>
...
<script type="text/javascript" src="js/relationshipReport.js${requestScope.ver}"></script>
</body>
</html>